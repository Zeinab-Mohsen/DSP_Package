...
Task_1_menu.add_command(label="Read Signal File",
                        command=show_read_signal_file_frame)
Task_1_menu.add_command(label="Generate Signal",
                        command=show_generate_signal_frame)
...
# Add Label
label = tk.Label(read_signal_file_frame,
                 text="Read Signal File", font=label_font)
...
generate_button = tk.Button(brows_frame, text="Read File",
                            font=button_font, width=20, command=browse_button_command)
...
canvas_continuous = FigureCanvasTkAgg(
    fig, continuous_signal_representation_frame)
...
label = tk.Label(generate_signal_frame,
                 text="Signals Generation", font=("Times New Roman", 25))
label.pack()
...
fig, ax = plt.subplots()
canvas = FigureCanvasTkAgg(fig, generate_signal_frame)
