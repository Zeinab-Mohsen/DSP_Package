...
subtract_signals_button = CustomButton(
    subtraction_frame, command=subtract_signals, text="Subtract two signals"
)
subtract_signals_button.pack(side=tk.TOP, padx=250, pady=10)

# Add signal plot frame
signals_representation_frame = tk.Frame(subtraction_frame)
...
# Add signal plot frame
resultant_signal_representation_frame = tk.Frame(subtraction_frame)
